...
* 1.整理和產生NFO檔案並下載圖片
  ...
  **如果在[用戶端本機配置](/zh-Hant/client_configuration.html#資料夾配置)中，設定`刮削資料夾`與`輸出資料夾`一致，可實現在原資料夾（刮削資料夾）下整理和產生NFO檔案並下載圖片**
...
* 若要**解析度**大寫，大寫填寫即可，`RESOLUTION` `RESOLUTION2`
* 若要**檔案副檔名**大寫，大寫填寫即可，`SUFFIX`
...
### 字段轉換設定
[自訂字段對應表](/zh-Hant/client_configuration.html#自訂欄位對應表)